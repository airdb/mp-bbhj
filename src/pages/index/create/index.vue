      ...
      <view style="width: 100%">
        ...
        <view class="pic-wrap">
          <block v-if="userData.photos.length < 9">
            <view class="pic-add" @click="uploadImage"></view>
          </block>
      ...
      chooseImage({
        success(res) {
          ...
          uploadFile({
            ...
            success(res) {
              const data = res.data;
              console.log("filename", tempFilePaths[0]);
              console.log("upload file successfully", res.data);
              //do something
            },
            fail(res) {
